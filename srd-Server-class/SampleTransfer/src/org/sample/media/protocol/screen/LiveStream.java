...
public class LiveStream implements PushBufferStream, Runnable {
	...
	/*rgbFormat = new VideoFormat(VideoFormat.JPEG,
											size,
											maxDataLength,
											Format.byteArray,
	...
	*/
    ...
    public void read(Buffer buffer)throws IOException{
    	synchronized (this) {
    		...
    		if (outdata == null || !(outdata.getClass() == /*Format.byteArray*/Format.intArray) ||
    				((/*byte[]*/int[])outdata).length < maxDataLength) {
    			outdata = new int/*byte*/[maxDataLength];
