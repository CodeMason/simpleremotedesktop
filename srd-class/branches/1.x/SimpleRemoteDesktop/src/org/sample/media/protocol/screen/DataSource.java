...
public class DataSource extends PushBufferDataSource {
	...
	if (streams == null) {
	    ...
	    stream = streams[0] = new LiveStream(new MediaLocator("screen://0,0,1024,768/30"));//new LiveStream(new MediaLocator("screen://0,0,100,100/10"));//new LiveStream(getLocator());
	}
	return streams;
    }
}
